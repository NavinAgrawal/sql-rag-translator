# Fix the generate_banking_data.py file
cat > data/sample_data/generate_banking_data.py << 'EOF'
#!/usr/bin/env python3
"""
...
class BankingDataGenerator:
    ...
    def generate_employees(self, count=800):
        ...
        for i in range(count):
            ...
            email = f"{first_name.lower()}.{last_name.lower()}@bankexample.com"
    ...
    def generate_customers(self, count=5000):
        ...
        for i in tqdm(range(count), desc="Creating customers"):
            ...
            """, (
                ...
                annual_income, random.choice(employment_statuses), fake.company(),
                fake.job(), credit_score, customer_since,
    ...
    def generate_product_categories(self):
        ...
        categories = [
            ...
            ('CREDIT_CARD', 'Credit Cards', 'CARD', 'Credit card products'),
            ('DEBIT_CARD', 'Debit Cards', 'CARD', 'Debit card products'),
    ...
    def generate_products(self, count=50):
        ...
        for i in range(count - products_created):
            ...
            product_name = f"{fake.company()} Product"
    ...
    def generate_transaction_types(self):
        ...
        types = [
            ...
            ('TRANSFER_IN', 'Transfer In', 'Incoming transfer', 'CREDIT', False, False, False),
            ('TRANSFER_OUT', 'Transfer Out', 'Outgoing transfer', 'DEBIT', False, True, False),
            ...
            ('ACH_DEBIT', 'ACH Debit', 'Automated clearing house debit', 'DEBIT', False, False, True),
            ('ACH_CREDIT', 'ACH Credit', 'Automated clearing house credit', 'CREDIT', False, False, True),
   ...
   def generate_merchants(self, count=1000):
       ...
       for i in tqdm(range(count), desc="Creating merchants"):
           ...
           dba_name = merchant_name if random.random() < 0.7 else fake.company()
